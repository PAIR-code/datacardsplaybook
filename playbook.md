...
{% include cards.html activity=true cards=site.data.00 %}
...
{% include cards.html activity=true cards=site.data.01 %}
...
{% include cards.html activity=true cards=site.data.02 %}
